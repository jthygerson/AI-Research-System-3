...
class ReportWriter:
    ...
    def write_report(self, best_idea, experiment_plan, final_results, performance_metrics):
        ...
        """
        report_name = self.create_report_name(best_idea['idea'])
        ...
        try:
            with open(report_path, 'w') as report_file:
                ...
                report_file.write(f"Idea Score: {best_idea['score']}\n")
                report_file.write(f"Justification: {best_idea['justification']}\n\n")
