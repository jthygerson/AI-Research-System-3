...
class IdeaEvaluator:
    ...
    def evaluate_ideas(self, ideas):
        ...
        This method is called by the orchestrator to score the ideas generated by IdeaGenerator.
        """
        ...
        for idea in ideas:
            try:
                ...
                try:
                    ...
                    # Log the total score for the idea
                ...
                # Log any errors that occur during idea evaluation
                self.logger.error(f"Error evaluating idea '{idea[:50]}...': {str(e)}")
                self.logger.error(traceback.format_exc())

        # Log the parsed evaluation data for debugging
